        ...
        <div class="table-responsive mt-4" style="min-height: 300px;">
            <table class="table table-hover">
                ...
                ?>
                    ...
                    <tr>
                        <td class="font-weight-bold">DL060802<?= $row3['id']; ?></td>
                        ...
                        <td>
                            ...
                            <a class="btn btn-sm btn-danger font-regular" href="confirm_process.php?action=delete&id=<?= $row3['id']; ?>" onclick="return confirm('Are you sure want to delete this record?')">
