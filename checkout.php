                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-4 d-inline">
                                    <div class="row">
                                        ...
                                        ?>
                                            <?php
                                            echo "<div class='input-group mb-3 d-flex justify-content-between'><div class='me-3 font-semibold fs-5'>Quantity</div><input class='form-control rounded-3' name='quantity' id='quantity'></div>";
                                            ?>
                                        <?php } else { ?>
                ...
                <div class="row justify-content-between">
                    ...
                    <div class="row mt-3 py-3 mb-5">
                        ...
                        <div class="col d-flex justify-content-end">
                            ...
                            ?>
                                <?php
                                echo "<button type='submit' class='btn btn-primary button-theme font-regular px-5 btn-block'>Add to cart</button>";
                                ?>
                            <?php } else { ?>
