...
<body>
        ...
        <div class="row">
            ...
            <div class="col-4 font-bold" id="date-orderid">
                <div class="row">
                    ...
                    <div class="col">
                        <div class="text-start font-semibold blue-theme"><?= $row3['date']; ?></div>
                        <!-- <input type="text" readonly class="form-control font-medium" value="<?= $row3['date']; ?>"> -->
                    </div>
                </div>
                <div class="row py-3">
                    <div class="col">
                    ...
                    <div class="col">
                        <p class="blue-theme font-semibold">DL060802<?= $row3['id'] ?></p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <table class="table table-hover">
                ...
                ?>
                    ...
                    <tr>
                        ...
                        <td><?= $row2['quantity']; ?></td>
                        <td class="font-weight-bold"><?= $row2['harga_jual']; ?></td>
                        <td>
    ...
    <div class="container pb-3 pt-3 px-5">
        <div class="row py-3">
            ...
            <div class="col">
                <div class="text-start font-medium"><?= $row3['fname']; ?> <?= $row3['lname']; ?></div>
        ...
        <div class="row py-3">
            ...
            <div class="col">
                <div class="text-start font-medium"><?= $row3['email']; ?></div>
            </div>
            <div class="col font-bold">
                Tax
            </div>
    ...
    <div class="container d-flex justify-content-between py-5">
        ...
        <div>
            <!-- <button class="btn btn-lg btn-primary btn-block" id="button-proceed" type="button" >Proceed</button> -->
        </div>
    </div>
