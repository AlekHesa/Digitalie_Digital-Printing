                ...
                <div class="row row-cols-1 row-cols-md-3 g-4 py-3 mb-5">
                    <div class="col">
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            <a href="#"><img src="assets/materials/doff.png" class="card-img-top py-3 px-3" alt="..."></a>
                            <div class="card-body">
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <button class="btn button-theme2 font-regular px-2"><i class="fa fa-heart-o" aria-hidden="true"></i> Watch</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    <div class="col">
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            <a href="#"><img src="assets/materials/sublime.png" class="card-img-top py-3 px-3" alt="..."></a>
                            <div class="card-body">
                                <a href="#" class="text-decoration-none text-black blue-hover">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            <a href="#"><img src="assets/materials/vinyl.png" class="card-img-top py-3 px-3" alt="..."></a>
                            <div class="card-body">
                                <a href="#" class="text-decoration-none text-black blue-hover">
                    ...
                    <div class="col">
                        ...
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            <a href="#"><img src="assets/materials/laster.png" class="card-img-top py-3 px-3 " alt="..."></a>
                            <div class="card-body">
                                <a href="#" class="text-decoration-none text-black blue-hover">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            <a href="#"><img src="assets/materials/canvas.png" class="card-img-top py-3 px-3" alt="..."></a>
                            <div class="card-body">
                                <a href="#" class="text-decoration-none text-black blue-hover">
                    ...
                    <div class="col">
                        <div class="card h-100 rounded-3 img-hover-zoom">
                            ...
                            <a href="#"><img src="assets/materials/dside.png" class="card-img-top py-3 px-3" alt="..."></a>
                            <div class="card-body">
                                <a href="#" class="text-decoration-none text-black blue-hover">
